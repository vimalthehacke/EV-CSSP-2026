...
export const TerminalComponent: React.FC<TerminalComponentProps> = ({
  ...
  return (
    <div 
      ...
      className="flex-1 bg-black border border-gray-900 rounded-lg p-4 font-mono text-[11px] flex flex-col justify-between overflow-hidden relative cursor-text group h-full min-h-[350px] shadow-inner"
    >
      ...
      <div className="flex-1 overflow-y-auto space-y-1.5 pr-2 mb-3 max-h-[400px]">
