...
export const LabContainer: React.FC<LabContainerProps> = ({ lab, onClose }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 h-full max-h-[85vh] overflow-hidden text-gray-100">
      
      {/* LEFT COLUMN: Educational Manual and Checklist */}
      <div className="flex-1 lg:max-w-md flex flex-col justify-between overflow-y-auto space-y-5 pr-1 font-mono text-xs max-h-[38vh] lg:max-h-none custom-scrollbar">
